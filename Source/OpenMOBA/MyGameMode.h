...
*/
UCLASS()
class OPENMOBA_API AMyGameMode : public AGameMode
{
...
public:
	...
	// FOr OpenMOBA we need a way to trigger the blueprint function "EventOnPostLogin" manually.
	UFUNCTION(BlueprintImplementableEvent, Category = "UEtopia", meta = (DisplayName = "ReceiveEventOnPostLogin"))
		void ReceiveEventOnPostLogin(class APlayerController* NewPlayerController);

	// We will send this trigger by overriding HandleSeamlessTravelPlayer
