...
*/
UCLASS()
class OPENMOBA_API AMyPlayerController : public APlayerController
{
	GENERATED_BODY()
...
public:
	...
	// OpenMOBA uses data in the playerstate in blueprints.
	// We need to signal the reload of this data from c++
	// The naming is super confusing, but this is how they do it.
	// Calling this function will tell the server (IN BLUEPRINTS) that the player data has changed 
	UFUNCTION(BlueprintImplementableEvent, Category = "UEtopia", meta = (DisplayName = "ReceiveRecievePlayerState"))
		void ReceiveRecievePlayerState();
